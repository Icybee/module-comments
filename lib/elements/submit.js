!function (Brickrouge) {
	...
	Brickrouge.Widget.SubmitComment = new Class({
		...
		show: function()
		{
			...
			, wrapper = new Element('div.form-group.form-group--preview')

			wrapper.appendChild(header)
			wrapper.appendChild(target)
			wrapper.inject(this.source.getParent('.form-group'), 'after')
	...
	Brickrouge.register('SubmitComment', function (element, options) {

		return new Brickrouge.Widget.SubmitComment(element, options)
